...
public final class SpanBuilder {
     ...
     */
    public SpanBuilder setFlag(int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setForegroundColor(@ColorInt int color) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setBackgroundColor(@ColorInt int color) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setLineHeight(@IntRange(from = 0) int lineHeight) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setLineHeight(@IntRange(from = 0) int lineHeight, @Align int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setQuoteColor(@ColorInt int color) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setQuoteColor(@ColorInt int color, @IntRange(from = 1) int stripeWidth, @IntRange(from = 0) int gapWidth) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setLeadingMargin(@IntRange(from = 0) int first, @IntRange(from = 0) int rest) {
        this.first = first;
        this.rest = rest;
        return this;
    }
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setBullet(@IntRange(from = 0) int gapWidth) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setBullet(@ColorInt int color, @IntRange(from = 0) int radius, @IntRange(from = 0) int gapWidth) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(Bitmap bitmap) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(Bitmap bitmap, int gapWidth, @Align int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(Drawable drawable) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(Drawable drawable, int gapWidth, @Align int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(Uri uri) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(Uri uri, int gapWidth, @Align int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(@DrawableRes int resourceId) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(@DrawableRes int resourceId, int gapWidth, @Align int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setFontSize(@IntRange(from = 0) int size) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setFontSize(@IntRange(from = 0) int size, boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setFontProportion(@FloatRange(from = 0, fromInclusive = false) float proportion) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setFontXProportion(@FloatRange(from = 0, fromInclusive = false) float proportion) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setFontFamily(@NonNull String fontFamily) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setTypeface(@NonNull Typeface typeface) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setAlign(@NonNull Alignment alignment) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setClickSpan(@NonNull ClickableSpan clickSpan) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setUrl(@NonNull String url) {
        this.url = url;
        return this;
    }
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setBlur(@FloatRange(from = 0, fromInclusive = false) float radius, Blur style) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setShader(@NonNull Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setShadow(@FloatRange(from = 0, fromInclusive = false) float radius, float dx, float dy, int shadowColor) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setSpans(@NonNull Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder append(@NonNull CharSequence text) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendLine(@NonNull CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendImage(@NonNull Bitmap bitmap) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendImage(@NonNull Bitmap bitmap, @Align int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendImage(@NonNull Drawable drawable) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendImage(@NonNull Drawable drawable, @Align int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendImage(@NonNull Uri uri) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendImage(@NonNull Uri uri, @Align int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendImage(@DrawableRes int resourceId) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendImage(@DrawableRes int resourceId, @Align int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendSpace(@IntRange(from = 0) int size) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder appendSpace(@IntRange(from = 0) int size, @ColorInt int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
