...
public class RingProgressBar extends View {
  ...
  public RingProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    //初始化属性
    TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RingPropertyProgressBar);

    ringColor = mTypedArray.getColor(R.styleable.RingPropertyProgressBar_ringColor, Color.BLACK);
    ringProgressColor = mTypedArray.getColor(R.styleable.RingPropertyProgressBar_ringProgressColor,
        Color.WHITE);
    textColor = mTypedArray.getColor(R.styleable.RingPropertyProgressBar_textColor, Color.BLACK);
    textSize = mTypedArray.getDimension(R.styleable.RingPropertyProgressBar_textSize, 16);
    ringWidth = mTypedArray.getDimension(R.styleable.RingPropertyProgressBar_ringWidth, 5);
    max = mTypedArray.getInteger(R.styleable.RingPropertyProgressBar_maxProgress, 100);
    textIsShow = mTypedArray.getBoolean(R.styleable.RingPropertyProgressBar_textIsShow, true);
    style = mTypedArray.getInt(R.styleable.RingPropertyProgressBar_style, 0);
